...
// the module opens on General. Every pre-V2 assertion below is preserved
...
// Reads a General row's rendered amount by its stable testid.
function generalRow(container, testId) {
