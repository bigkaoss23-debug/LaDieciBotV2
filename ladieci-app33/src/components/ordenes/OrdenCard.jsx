...
const OrdenCard = ({o, onModifica, accentColor, hasAlert, onElimina, onConfirm, onForzarEntrega, vipIds, loadingIds = new Set()}) => {
  ...
  const styles = {
    [ORDER_STATES.POR_CONFIRMAR]: {
      bg:     "linear-gradient(145deg,rgba(6,182,212,0.52) 0%,rgba(14,165,233,0.32) 50%,rgba(3,105,161,0.46) 100%)",
      border: "1.5px solid rgba(103,232,249,0.60)",
    ...
    [ORDER_STATES.EN_COCINA]: {
      bg:     "linear-gradient(145deg,rgba(29,78,216,0.52) 0%,rgba(37,99,235,0.32) 50%,rgba(17,50,160,0.46) 100%)",
      border: "1.5px solid rgba(96,165,250,0.58)",
    ...
    [ORDER_STATES.LISTO]: {
      bg:     "linear-gradient(145deg,rgba(30,58,138,0.58) 0%,rgba(29,78,216,0.28) 50%,rgba(17,50,130,0.50) 100%)",
