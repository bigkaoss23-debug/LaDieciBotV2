...
// including new tests, is fully in scope.
//
// Note: this frontend has no `messa`-named migration family (the historical
// V3-H/I/J/K messa SQL lives only in the backend repo, per
// docs/contrato-linguistico-dominio.md) — the only exception here is the
// guard's own self-reference.
const ALLOWLIST_PATTERNS = [
  // The guard's own source and its unit test: they must hold the
  ...
  /^src\/domainLanguageGuard\.test\.js$/,
];
